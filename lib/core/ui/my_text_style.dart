...
class MyTextStyle {
  ...
  static Map<MyTextType, double> _defaultTextSize = {
    MyTextType.displayLarge: 50,
    MyTextType.displayMedium: 40,
    MyTextType.displaySmall: 32,
    MyTextType.headlineLarge: 28,
    MyTextType.headlineMedium: 25,
    MyTextType.headlineSmall: 22,
    MyTextType.titleLarge: 20,
    MyTextType.titleMedium: 14,
    MyTextType.titleSmall: 12,
    MyTextType.labelLarge: 12,
    MyTextType.labelMedium: 10,
    MyTextType.labelSmall: 9,
    MyTextType.bodyLarge: 14,
    MyTextType.bodyMedium: 12,
    MyTextType.bodySmall: 10,
  };
