...
class CustomPopupMenuState extends State<CustomPopupMenu> with SingleTickerProviderStateMixin {
  late GlobalKey _key;
      ...
      builder: (context) {
        return GestureDetector(
          ...
          child: Container(
            ...
            color: widget.backdrop ? theme.colorScheme.onSurface.withAlpha(12) : Colors.transparent,
          ),
        );
      },
    );
