  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      borderRadius: boxShape != BoxShape.circle
          ? borderRadius ??
              BorderRadius.all(
                Radius.circular(borderRadiusAll ?? UIConstants.cardRadius),
              )
          : null,
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: boxShape != BoxShape.circle
              ? borderRadius ??
                  BorderRadius.all(
                    Radius.circular(
                      borderRadiusAll ?? UIConstants.cardRadius,
                    ),
                  )
              : null,
          border: bordered ? border ?? Border.all(color: theme.dividerColor) : null,
