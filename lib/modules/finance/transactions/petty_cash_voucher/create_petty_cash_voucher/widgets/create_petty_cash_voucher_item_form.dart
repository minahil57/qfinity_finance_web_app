...
class CreatePettyCashVoucherItemForm extends StatefulWidget {
  const CreatePettyCashVoucherItemForm({super.key});

  @override
  State<CreatePettyCashVoucherItemForm> createState() => _CreatePettyCashVoucherItemFormState();
}

class _CreatePettyCashVoucherItemFormState extends State<CreatePettyCashVoucherItemForm> {
  @override
  void initState() {
    super.initState();
    Get
      ..delete<CreatePettyCashVoucherItemFormController>()
      ..put(CreatePettyCashVoucherItemFormController());
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<CreatePettyCashVoucherItemFormController>(
      builder: (controller) {
        return Form(
          ...
          child: Column(
            children: [
              ...
              if (controller.showCostCenters) ...[
                SizedBox(height: UIConstants.formInputFieldSpacing),
                const CostCentersBuilder<CreatePettyCashVoucherItemFormController>(
                  hideCopyCostCenters: true,
                ),
              ],
              SizedBox(height: flexSpacing),
              if (controller.createPettyCashVoucherController.toBeEditedItem != null)
                UpdateCancelButtons(
