...
class CreatePettyCashVoucherTransactionDetails extends StatelessWidget {
  const CreatePettyCashVoucherTransactionDetails({super.key});
            ...
            children: [
              ...
              MyFlex(
                ...
                children: [
                  MyFlexItem(
                    ...
                    child: Column(
                      children: [
                        ...
                        const NarrationBuilder<CreatePettyCashVoucherController>(),
                      ],
                    ),
                  ),
                  MyFlexItem(
                    ...
                    child: Column(
                      children: [
                        const CurrencySelectionBuilder<CreatePettyCashVoucherController>(
                          amountLabel: 'Base Amount (Cr)',
                        ),
                        MySpacing.height(UIConstants.formInputFieldSpacing),
                        const TaxCodeBuilder<CreatePettyCashVoucherController>(),
                      ],
                    ),
                  ),
                  MyFlexItem(
                  ...
                  const MyFlexItem(
                    sizes: 'lg-3 md-6 sm-12',
                    child: CostCentersBuilder<CreatePettyCashVoucherController>(),
                  ),
                ],
              ),
              MySpacing.height(flexSpacing * 1.5),
